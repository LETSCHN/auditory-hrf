...
set dir = /Volumes/Elements/HiHi
set subjreg = S07s1
set subj = 250127_105349
set subject = letsch
set subjectname = s07
set sub = s7
...
#               --tval /Users/letitia/Documents/subjects/$subject/label/$hemi.fsaverage.aparc.annot
# end
...
#LH
# foreach roi (C_A5	M_A5	R_A5	RP	R_A4	M_A4	MPr	C_A4	MPc	CP	TA3	TA2	RTL	AL	ML	RM	MM	CL	CM	A1	RT	R)
