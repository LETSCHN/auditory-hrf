...
% correlation, ERA, SD cutoff to increase power for small ROIs).
...
infile = '_cutoff1500_common_sessions.mat'; % s0X_infile, per subject all data no correlation, ERA, SD cutoff

outpath = [inpath 'updated_model6/'];
hemi = {'rh'};% {'rh'}
outfile = 'fittedAmpPeakFWHM_ROIs_cutoff1500_allsess.mat';

roidir = ['/path/to/auditory_HRF/analyses_2025/ROIs'];
...
%% model initialization (upper and lower limits + start)
...
%             pause
            ...
            % === Store peak/fwhm/amp for all-session ERA ===
