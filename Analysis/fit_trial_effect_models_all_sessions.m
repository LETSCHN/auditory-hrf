...
% Output: training_s0X_trialeffect.mat files, containing fitted model
% parameters, best-model labels, adjusted R-squared values, and train.
%
...
% size of itr loop! Modified in Dec by IZ to avoid overwriting of "rsq"
