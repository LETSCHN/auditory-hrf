%%%This script is used to take all ROI parameters from dset1/2 and store
%%%them in a spreadsheet

clc; clear;
output_path = '/Users/letitia/Dropbox/auditory_HRF/analyses_2025/ROI_peak_fwhm_amp';

all_data = {};
dataset_paths = {
    '/Volumes/Elements/auditory_HRF/analyses_2025/updated_model6', 'Dataset1';
    '/Volumes/Elements/HiHi/updated_model6', 'Dataset2'
};
