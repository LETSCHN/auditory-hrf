%%This script loads z-scores saved by "zscore_fast_slow_maps.m" and maps
%%ROI names to colours. The loaded z-scores are reordered to match
...
% Choose colormap: 'jet' or 'blue_white_red'
colormap_name = 'jet';
...
switch lower(colormap_name)
    ...
    otherwise
        error('colormap_name must be ''jet'' or ''blue_white_red''.');
end
